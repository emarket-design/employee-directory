...
$container = apply_filters('emd_change_container','emd-wrapper','empd_com', 'archive');  
$has_sidebar = apply_filters( 'emd_show_temp_sidebar', 'right', 'empd_com', 'archive');
...
<?php
	do_action('emd_archive_before_header', 'empd-com',$post->post_type);
	emd_get_template_part('empd-com', 'archive', str_replace("_","-",$post->post_type) . '-aheader');
	do_action('emd_archive_after_header', 'empd-com',$post->post_type);
?>
	</div>
...
<?php
	while ( have_posts() ) : the_post(); ?>
			...
			<?php emd_get_template_part('empd-com', 'archive', str_replace("_","-",$post->post_type)); ?>
			</div>
...
<?php
	do_action('emd_archive_before_footer', 'empd-com',$post->post_type);
	emd_get_template_part('empd-com', 'archive', str_replace("_","-",$post->post_type) . '-afooter');
	do_action('emd_archive_after_footer', 'empd-com',$post->post_type);
?>
</div>
<?php	$has_navigation = apply_filters( 'emd_show_temp_navigation', true, 'empd_com', 'archive');
	if($has_navigation){
		global $wp_query;
